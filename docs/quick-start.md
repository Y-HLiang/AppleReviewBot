...
3. 复制浏览器地址栏的 URL，例如：
   ```
   https://apps.apple.com/tw/app/example/id1526117209
   ```
4. 记录下 `id` 后面的数字：`1526117209`
5. 记录下国家代码（URL 中的 `cn`、`us` 等）

**示例：**
- 示例应用（台湾）：`1526117209` / `tw`
...
- 尝试在浏览器中访问 API：
  ```
  https://itunes.apple.com/tw/rss/customerreviews/id=1526117209/sortBy=mostRecent/json
  ```
